    ...
    if (_isBase64Image(imageString)) {
      ...
      if (imageBytes != null) {
        return ClipRRect(
          ...
          child: Image.memory(
            ...
            errorBuilder:
                (_, __, ___) =>
                    Icon(Icons.image_not_supported, size: size * 0.7),
          ),
        );
      }
    } else {
      ...
      return ClipRRect(
        ...
        child: Image.network(
          ...
          fit: BoxFit.cover,
          errorBuilder:
              (_, __, ___) => Icon(Icons.image_not_supported, size: size * 0.7),
        ),
      );
    }

    // Fallback if image can't be loaded
    return Icon(Icons.image_not_supported, size: size * 0.7);
  }
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                if (service.specialOffer?.isNotEmpty ==
                                    true) ...[
